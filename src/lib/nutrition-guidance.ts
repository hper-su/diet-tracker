...
export const INTRO_AFTER =
  "ことが土台になります。その上で、同じ摂取カロリーでも「何を食べるか」で、続けやすさと結果の質(筋肉量の維持・リバウンドのしにくさ)が変わってきます。";
...
export const NUTRITION_PRIORITIES: NutritionPriority[] = [
  ...
  },
  {
    ...
    closingParagraph:
      "減量中に脂質の量を減らしたい場合は、まず飽和脂肪酸(揚げ物・加工肉・バターなど)から減らし、不飽和脂肪酸、特にオメガ3を含む魚やオリーブオイルはできるだけ残すのがおすすめです。",
  },
  {
    order: 3,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "白米・パン・麺類を完全にやめる必要はありません。まずは主食を低GIのものに置き換える、あるいは野菜やタンパク質を先に食べてから主食を摂る(食べる順番)だけでも、血糖値の波はかなり穏やかになります。",
    ],
  ...
  },
  {
    ...
    closingParagraph:
      "特定の食品グループを丸ごと避けるような極端な食事制限をしている場合は、特に不足しやすいので注意しましょう。",
  },
];
